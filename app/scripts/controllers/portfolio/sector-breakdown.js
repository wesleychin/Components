...
.controller('SectorBreakdownCtrl', function ($scope, $http, $timeout, $filter) {
	$scope.instruments = [{id:1, name: 'Banks'}, {id:2, name: 'Diversified Industrials'}, {id:3, name: 'Exchange Traded Funds'}, {id:4, name: 'Exchange Traded Notes'}, {id:5, name: 'Food Products'}];
